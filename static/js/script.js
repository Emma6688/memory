...
function congratulationMsg()
{
    ...
    var newImgElement = document.createElement("img");
    newImgElement.src = "static/images/congratulaions.jpg";
    newImgElement.id = "congratulaionsImg";
    newImgElement.alt = "Congratulations! You won!!!";
    congratulation.appendChild(newImgElement);
}

//Click button Restart Game
function reloadPage()
{
    location.reload();
}